-- Rolled-back probe for 2026-09-26_0313. Run as ONE query: begin; old_temp.sql; new_temp.sql; cases.sql; rollback;
-- old_temp.sql is the 2026-09-09_1230 body (the control: case C1 must find a stranded linked NULL-status job).
-- cases_mut.sql points case C2 at the old body and MUST fail with 'C2: new body did not raise 23505'.
-- The gid is fake (gid://Jobber/Job/999999901); 99901068 is a recycled number held by a live job.
do $$
