-- ============================================================================
-- 2026-06-11 — customer.work_orders: exclude soft-deleted visits
-- ============================================================================
-- The view filtered derm_manifests.deleted_at but NOT visits.deleted_at
-- (it was on the documented 2026-05-29 pending-follow-up list). A visit
-- soft-deleted after completion would still render as a customer work order
-- in the Field Portal. 0 rows affected today (verified) — preventive fix.
-- Audit (ADR 010): view-only change, no table auditing impact.
-- ============================================================================
