...
**Matcher, read-only (Task 2)**: `docs/migrations/2026-09-14_0605_generated_page_matcher.sql`
...
**Phase 0 (Task 3)**: `scripts/probes/generated_finisher/phase0_corpus.mjs`, `phase0_calibration.json`, `phase0_report.md`, `.gitignore` (`img/`).

**Precedence (Task 4)**: `docs/migrations/2026-09-14_0610_template_rules_precedence.sql` generated by `scripts/probes/generated_finisher/gen_precedence_migration.py`
...
**Finisher core (Task 5)**: `docs/migrations/2026-09-14_0615_generated_sheet_finisher.sql`
...
**Cron (Task 7)**: `docs/migrations/2026-09-14_0620_generated_sheet_finisher_cron.sql`: `public.fn_request_generated_measure()`, job `generated-sheet-finisher` at `6-59/10 * * * *`.
...
**Files:**
- Create: `docs/migrations/2026-09-14_0605_generated_page_matcher.sql`
...
```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && node scripts/probes/apply_sql_file.mjs docs/migrations/2026-09-14_0605_generated_page_matcher.sql rehearse
```
...
```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && node scripts/probes/apply_sql_file.mjs docs/migrations/2026-09-14_0605_generated_page_matcher.sql
```
...
```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && git pull -q --rebase origin main && git add docs/migrations/2026-09-14_0605_generated_page_matcher.sql && git commit -q -m "Generated-sheet matcher: layout-guided boundary matching as read-only functions" -m "derm.fn_match_generated_page (pure), derm.fn_generated_page_cards and the derived template, so Phase 0 can replay the real algorithm over every accepted generated page before anything writes." -m "Co-Authored-By: Claude Opus 5 <noreply@anthropic.com>" && git push -q origin main && git log -1 --format='%h %s'
```
...
- Create (by running it): `scripts/probes/generated_finisher/phase0_calibration.json`, `phase0_report.md`
...
- Create (generated): `docs/migrations/2026-09-14_0610_template_rules_precedence.sql`
...
```python
# Generates docs/migrations/2026-09-14_0610_template_rules_precedence.sql from the LIVE view and
...
header = '''-- ============================================================================================
-- 2026-09-14_0610_template_rules_precedence.sql   (GENERATED by
...
-- by the finisher (derm.fn_generated_page_measured, migration 2026-09-14_0615). Precedence per page:
...
out = os.path.join(root, 'docs', 'migrations', '2026-09-14_0610_template_rules_precedence.sql')
...
```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && node scripts/probes/apply_sql_file.mjs docs/migrations/2026-09-14_0610_template_rules_precedence.sql
```
...
**Files:**
- Create: `docs/migrations/2026-09-14_0615_generated_sheet_finisher.sql`
...
`scripts/probes/generated_finisher/phase0_calibration.json`. The VERIFY fixture's detector lines are
...
DECLARE
  ...
  v_lines jsonb := '@@LINES_834742_P2@@'::jsonb;    -- phase0_calibration.json -> lines["ticket-834742_p2"].lines
...
Replace the two `-- REPLACE` lines in PART 1 with `calibrated_prior` and `tolerances` from `phase0_calibration.json` (six numbers with three decimals; match/gap/clear to two decimals), then:

```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && grep -n -- "-- REPLACE" docs/migrations/2026-09-14_0615_generated_sheet_finisher.sql; node scripts/probes/apply_sql_file.mjs docs/migrations/2026-09-14_0615_generated_sheet_finisher.sql rehearse
```
...
```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && node scripts/probes/apply_sql_file.mjs docs/migrations/2026-09-14_0615_generated_sheet_finisher.sql
```
...
block = anchor + '''
# measure-generated-page: the generated-sheet finisher's detector (2026-09-14). Invoked by pg_cron
...
**Files:**
- Create: `docs/migrations/2026-09-14_0620_generated_sheet_finisher_cron.sql`
...
```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && node scripts/probes/apply_sql_file.mjs docs/migrations/2026-09-14_0620_generated_sheet_finisher_cron.sql rehearse && node scripts/probes/apply_sql_file.mjs docs/migrations/2026-09-14_0620_generated_sheet_finisher_cron.sql
```
...
```bash
cd "C:/Users/FRED/Desktop/Virtrify/Yannick/Claude/Supabase" && git pull -q --rebase origin main && git add docs/migrations/2026-09-14_0620_generated_sheet_finisher_cron.sql && git commit -q -m "Schedule the generated-sheet finisher every ten minutes" -m "Co-Authored-By: Claude Opus 5 <noreply@anthropic.com>" && git push -q origin main && git log -1 --format='%h %s'
```
...
```markdown
## 2026-09-14 - generated sheets measure and complete themselves (server; no app deploy)
...
DB side: Supabase `CLAUDE.md` "GENERATED SHEETS FINISH THEMSELVES", migrations `2026-09-14_0605`
...
```markdown
**Generated sheets measure and complete themselves (2026-09-14).** A cron measures each stamped page
...
- [ ] **Step 3: The spec.** Two Edit-tool replacements in `docs/superpowers/specs/2026-09-14-generated-sheet-auto-measure-and-complete-design.md`, each old string occurring once:
  - old: `*Design, 2026-09-14. Not built. Fred: "go, write the design first."*`
    new: `*Design, 2026-09-14. Built 2026-09-14 (plan: docs/superpowers/plans/2026-09-14-generated-sheet-finisher.md). Step A (section 4.A) is NOT built, pending Fred.*`
