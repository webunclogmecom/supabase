...
- Only **4 non-zero findings** — 2 fixed, 2 are by-design (not corruption), 1 minor.
...
| 4 | Clients with no source link | 3 | 1 was the dup orphan (224, removed). 2 are real clients missing provenance: `050-PV` Pura Vida Brickell (INACTIVE) + `150-KOS` Kosh (RECURRING). Minor — clients are correct, just untraceable to a source. Will self-resolve at the AT-sunset wipe+repop, or can be backfilled. |
...
## Open (minor)
- Backfill source links for `050-PV` (id 41) + `150-KOS` (id 336) — optional.
