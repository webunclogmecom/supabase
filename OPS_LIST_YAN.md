...
_Generated 2026-05-14 from live Supabase audit. 51 total rows across 3 priority buckets._

Fix everything in Airtable. Our DB syncs on the next `populate.js --step=5` run.

## Part 1 — NEEDS_FREQ (0 rows) — HIGH PRIORITY
...
## Part 2 — NEEDS_PRICE (0 rows) — MEDIUM PRIORITY
...
## Part 3 — NEEDS_BOTH (51 rows) — LOW PRIORITY (decide: real or noise)
...
| 025-GRO GRO Grove Kosher LLC (Harding Ave) | LS | fill in or uncheck |
...
| 057-SLS BAY Bayshore executive Plaza (SLS Shaulson Lyft Station) | LS | fill in or uncheck |
...
| 070-TCE TCE The carrot express Miami shores | LS | fill in or uncheck |
...
| 083-SHUL SHUL The Shul | LS | fill in or uncheck |
...
| 116-HIK HIK Hikari Miami | LS | fill in or uncheck |
| 132-PUM PU Pummarola | WD | fill in or uncheck |
| 167-FEN FEN Fendi Château Residences | LS | fill in or uncheck |
| 168-AVA AVA AVA | LS | fill in or uncheck |
